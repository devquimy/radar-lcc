                            ...
                            <form method="post" action="{{ route('documento.update', $documento->id) }}">
                                ...
                                <div class="row" style="padding-right: 15px;padding-left:15px">
                                    <div class="col-lg-6" style="margin-bottom:15px">
                                        ...
                                        <input type="text" name="nome_documento" value="{{ $documento->nome_documento }}" class="form-control" placeholder="Digite o nome do documento...">
                                    </div>
                                    <div class="col-lg-6" style="margin-bottom:15px">
                                        <label for="tipo_documento"><b>Tipo do documento:</b></label>
                                        <select name="tipo_documento" id="tipo_documento" class="form-control">
                                            <option value="">Selecione...</option>
                                            <option value="positivo" {{ ($documento->tipo_documento == 'positivo') ? 'selected' : '' }}>Positivo</option>
                                            <option value="negativo" {{ ($documento->tipo_documento == 'negativo') ? 'selected' : '' }}>Negativo</option>
                                            <option value="nulo" {{ ($documento->tipo_documento == 'nulo') ? 'selected' : '' }}>Nulo</option>
                                        </select>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="documento"><b>Documento:</b></label>
                                        <textarea id="documento" name="documento">{{ $documento->documento }}</textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <button class="btn btn-success btn-block" style="margin-top:15px">Editar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-warning">
                                ...
                                <p>
                                    <b>@{{nome_empresa}}</b> = Nome da empresa
                                </p>
                            </div>
                        </div>
                      </div>
