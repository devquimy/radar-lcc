...
@section('content-auth')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/ativos_fisicos_form" class="btn btn-sm btn-primary shadow-sm">
                        ...
                        <table class="table data_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>0</td>
                                    <td>
                                        <a href="javascript:void(0);" data-id="65" class="btn bg-primary text-white btn-circle btn-sm btnDelete" id="btnDelete" data-toggle="modal" data-target="#novo_estudo_65" title="Refazer estudo">
                                            <i class="fas fa-fw fa-chart-area"></i>
                                        </a>
                                        <a href="/ativos_fisicos_form" class="btn btn-warning btn-circle btn-sm">
                                        ...
                                        <div class="modal" id="novo_estudo_65" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            Você está iniciando um novo estudo.<br>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="buttom" id="deleteConfirm" class="btn btn-primary">Continuar</button>
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                                            <input type="hidden" name="companyId" id="idToDelete" value="65">
                                                        </form>
                                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>456</td>
                                    <td>2020</td>
                                    <td><a href="<?=$url?>/estudos_lista"><small class="bg-primary text-white d-inline-flex px-2 py-1 rounded">1</small></a></td>
                                    <td>
                                        <a href="<?=$url?>/estudos_lista" class="btn bg-primary btn-circle btn-sm text-white">
                                            <i class="fas fa-fw fa-chart-area"></i>
                                        </a>
                                        <a href="<?=$url?>/ativos_fisicos_form" class="btn btn-warning btn-circle btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0);" data-id="65" class="btn btn-danger btn-circle btn-sm btnDelete" id="btnDelete" data-toggle="modal" data-target="#confirmationModal_65">
                                            <i class="fas fa-trash"></i>
                                ...
                                <tr>
                                    <td>GHI</td>
                                    <td>Correia transportadora</td>
                                    <td>789</td>
                                    <td>2019</td>
                                    <td>0</td>
                                    <td>
                                        <a href="<?=$url?>/estudos_form" class="btn bg-primary btn-circle btn-sm text-white">
                                            <i class="fas fa-fw fa-chart-area"></i>
                                        </a>
                                        <a href="<?=$url?>/ativos_fisicos_form" class="btn btn-warning btn-circle btn-sm">
                                            <i class="fas fa-edit"></i>
